package seoil.capstone.flashbid.infrastructure.id;


import org.springframework.stereotype.Component;
import seoil.capstone.flashbid.global.common.IdGenerate;

import java.util.random.RandomGenerator;

@Component
public class SnowflakeGenerator implements IdGenerate<Long> {
